...
export async function toggleReaction(
  ...
  switch (type) {
    ...
    default: {
      throw new GraphQLError('Invalid reaction type', { extensions: { code: 'BAD_USER_INPUT' } })
    }
  }
  ...
  if (!parentObject) {
    throw new GraphQLError('Reacting on something that doesn’t exist', { extensions: { code: 'BAD_USER_INPUT' } })
  }
